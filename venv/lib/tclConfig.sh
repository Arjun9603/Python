...
# installed.
TCL_PREFIX='/Users/arjunraghav/Python/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/arjunraghav/Python/venv'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/arjunraghav/Python/venv/include -fdebug-prefix-map=/var/folders/k1/30mswbxs7r1g6zwn8y4fyt500000gp/T/abs_da6qfnx8ca/croot/tk_1755243786242/work=/usr/local/src/conda/tk-8.6.15 -fdebug-prefix-map=/Users/arjunraghav/Python/venv=/usr/local/src/conda-prefix -pipe   -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/arjunraghav/Python/venv/lib -L/Users/arjunraghav/Python/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/arjunraghav/Python/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/arjunraghav/Python/venv/include'
...
TCL_PACKAGE_PATH='/Users/arjunraghav/Python/venv/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/arjunraghav/Python/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/arjunraghav/Python/venv/lib/libtclstub8.6.a'
